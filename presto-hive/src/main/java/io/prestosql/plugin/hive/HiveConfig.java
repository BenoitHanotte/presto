...
public class HiveConfig
{
    ...
    @ConfigDescription("Throttles the maximum number of splits that can be assigned to tasks per second. 0 disables throttling.")
    public HiveConfig setMaxSplitsPerSec(int maxSplitsPerSec)
    {
